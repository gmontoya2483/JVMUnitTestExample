...
* See [Ignoring tests](documentation/ignoring_test.md)
...
## Test fixtures (@Before, @After, @BeforeClass, @AfterClass)

* See [Test fixtures](documentation/fixtures.md)
* See [Understanding JUnit method order execution](https://garygregory.wordpress.com/2011/09/25/understaning-junit-method-order-execution/)
* See ```ExampleTestFixture``` class
